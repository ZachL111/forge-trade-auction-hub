"""Regression checks for the forge-trade-auction-hub casebook."""
...
from casebook.harness import assert_expected, forge_trade_auction_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_trade_auction_hub_summary(), assert_expected())
