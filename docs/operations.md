...
`forge-trade-auction-hub` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for auction systems, covering simulation kernel, seeded input scenarios, and failure-oriented tests.
...
The score is deterministic. The current threshold is 159. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
